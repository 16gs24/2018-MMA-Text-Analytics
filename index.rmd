...
and employ techniques discussed in class including some of tokenization, data cleaning, document clustering, topic modelling, and visualization.
...
```
- The job search is currently dominated by data scientists, which have become a catch all word. But it's encouraging to see machine learning engineers and developer roles begin to be fleshed out.
