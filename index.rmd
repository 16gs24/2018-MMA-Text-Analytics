...
```
- The job search is currently dominated by data scientists, which have become a catch all word.
- Analytics is surprisingly absent, but is likely wrapped into titles like "Manager, Analytics" which is more heterogeneous
...
```
- The search terms from analytics do see some overlap with data science. The algorithms that Indeed uses to match jobs look very interesting.
